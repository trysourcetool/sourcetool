...
const file_redis_v1_redis_proto_rawDesc = "" +
	"\n" +
	"\x14redis/v1/redis.proto\x12\x13sourcetool.redis.v1\"8\n" +
	"\fRedisMessage\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x18\n" +
	"\apayload\x18\x02 \x01(\fR\apayloadB\xe1\x01\n" +
	"\x17com.sourcetool.redis.v1B\n" +
	"RedisProtoP\x01ZLgithub.com/trysourcetool/sourcetool/backend/generated/proto/redis/v1;redisv1\xa2\x02\x03SRX\xaa\x02\x13Sourcetool.Redis.V1\xca\x02\x13Sourcetool\\Redis\\V1\xe2\x02\x1fSourcetool\\Redis\\V1\\GPBMetadata\xea\x02\x15Sourcetool::Redis::V1b\x06proto3"
