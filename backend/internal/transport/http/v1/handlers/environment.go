...
func (h *EnvironmentHandler) Get(w http.ResponseWriter, r *http.Request) {
	...
	if err := render.JSON(w, http.StatusOK, mapper.GetEnvironmentOutputToResponse(out)); err != nil {
		render.Error(r.Context(), w, err)
		return
	}
}
...
func (h *EnvironmentHandler) List(w http.ResponseWriter, r *http.Request) {
	...
	if err := render.JSON(w, http.StatusOK, mapper.ListEnvironmentsOutputToResponse(out)); err != nil {
		render.Error(r.Context(), w, err)
		return
	}
}
...
func (h *EnvironmentHandler) Create(w http.ResponseWriter, r *http.Request) {
	...
	if err := render.JSON(w, http.StatusOK, mapper.CreateEnvironmentOutputToResponse(out)); err != nil {
		render.Error(r.Context(), w, err)
		return
	}
}
...
func (h *EnvironmentHandler) Update(w http.ResponseWriter, r *http.Request) {
	...
	if err := render.JSON(w, http.StatusOK, mapper.UpdateEnvironmentOutputToResponse(out)); err != nil {
		render.Error(r.Context(), w, err)
		return
	}
}
...
func (h *EnvironmentHandler) Delete(w http.ResponseWriter, r *http.Request) {
	...
	if err := render.JSON(w, http.StatusOK, mapper.DeleteEnvironmentOutputToResponse(out)); err != nil {
		render.Error(r.Context(), w, err)
		return
	}
}
