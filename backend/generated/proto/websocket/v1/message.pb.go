...
const file_websocket_v1_message_proto_rawDesc = "" +
	"\n" +
	"\x1awebsocket/v1/message.proto\x12\x17sourcetool.websocket.v1\x1a\x1cexception/v1/exception.proto\x1a\x12page/v1/page.proto\x1a\x16widget/v1/widget.proto\"\xae\x06\n" +
	"\aMessage\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12B\n" +
	"\texception\x18\x02 \x01(\v2\".sourcetool.exception.v1.ExceptionH\x00R\texception\x12R\n" +
	"\x0finitialize_host\x18\x03 \x01(\v2'.sourcetool.websocket.v1.InitializeHostH\x00R\x0einitializeHost\x12n\n" +
	"\x19initialize_host_completed\x18\x04 \x01(\v20.sourcetool.websocket.v1.InitializeHostCompletedH\x00R\x17initializeHostCompleted\x12X\n" +
	"\x11initialize_client\x18\x05 \x01(\v2).sourcetool.websocket.v1.InitializeClientH\x00R\x10initializeClient\x12t\n" +
	"\x1binitialize_client_completed\x18\x06 \x01(\v22.sourcetool.websocket.v1.InitializeClientCompletedH\x00R\x19initializeClientCompleted\x12L\n" +
	"\rrender_widget\x18\a \x01(\v2%.sourcetool.websocket.v1.RenderWidgetH\x00R\frenderWidget\x12C\n" +
	"\n" +
	"rerun_page\x18\b \x01(\v2\".sourcetool.websocket.v1.RerunPageH\x00R\trerunPage\x12L\n" +
	"\rclose_session\x18\t \x01(\v2%.sourcetool.websocket.v1.CloseSessionH\x00R\fcloseSession\x12R\n" +
	"\x0fscript_finished\x18\n" +
	" \x01(\v2'.sourcetool.websocket.v1.ScriptFinishedH\x00R\x0escriptFinishedB\x06\n" +
	"\x04type\"\x95\x01\n" +
	...
	"sdkVersion\x12.\n" +
	"\x05pages\x18\x04 \x03(\v2\x18.sourcetool.page.v1.PageR\x05pages\"C\n" +
	...
	"\x04path\x18\x03 \x03(\x05R\x04path\x124\n" +
	"\x06widget\x18\x04 \x01(\v2\x1c.sourcetool.widget.v1.WidgetR\x06widget\"y\n" +
	"\tRerunPage\x12\x1d\n" +
	"\n" +
	"session_id\x18\x01 \x01(\tR\tsessionId\x12\x17\n" +
	"\apage_id\x18\x02 \x01(\tR\x06pageId\x124\n" +
	"\x06states\x18\x03 \x03(\v2\x1c.sourcetool.widget.v1.WidgetR\x06states\"-\n" +
	...
	"\x06status\x18\x02 \x01(\x0e2..sourcetool.websocket.v1.ScriptFinished.StatusR\x06status\"H\n" +
	"\x06Status\x12\x16\n" +
	"\x12STATUS_UNSPECIFIED\x10\x00\x12\x12\n" +
	"\x0eSTATUS_SUCCESS\x10\x01\x12\x12\n" +
	"\x0eSTATUS_FAILURE\x10\x02B\xff\x01\n" +
	"\x1bcom.sourcetool.websocket.v1B\fMessageProtoP\x01ZTgithub.com/trysourcetool/sourcetool/backend/generated/proto/websocket/v1;websocketv1\xa2\x02\x03SWX\xaa\x02\x17Sourcetool.Websocket.V1\xca\x02\x17Sourcetool\\Websocket\\V1\xe2\x02#Sourcetool\\Websocket\\V1\\GPBMetadata\xea\x02\x19Sourcetool::Websocket::V1b\x06proto3"
