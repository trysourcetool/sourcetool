...
func (h *AuthHandler) RequestMagicLink(w http.ResponseWriter, r *http.Request) {
	...
	if err := json.NewDecoder(r.Body).Decode(&req); err != nil {
		render.Error(r.Context(), w, errdefs.ErrInvalidArgument(err))
		return
	}
	...
	if err := render.JSON(w, http.StatusOK, mapper.RequestMagicLinkOutputToResponse(res)); err != nil {
		render.Error(r.Context(), w, err)
		return
	}
}
...
func (h *AuthHandler) AuthenticateWithMagicLink(w http.ResponseWriter, r *http.Request) {
	...
	if err := render.JSON(w, http.StatusOK, mapper.AuthenticateWithMagicLinkOutputToResponse(out)); err != nil {
		render.Error(r.Context(), w, err)
		return
	}
}
...
func (h *AuthHandler) RegisterWithMagicLink(w http.ResponseWriter, r *http.Request) {
	...
	if err := render.JSON(w, http.StatusOK, mapper.RegisterWithMagicLinkOutputToResponse(out)); err != nil {
		render.Error(r.Context(), w, err)
		return
	}
}
...
func (h *AuthHandler) RequestInvitationMagicLink(w http.ResponseWriter, r *http.Request) {
	...
	if err := render.JSON(w, http.StatusOK, mapper.RequestInvitationMagicLinkOutputToResponse(out)); err != nil {
		render.Error(r.Context(), w, err)
		return
	}
}
...
func (h *AuthHandler) AuthenticateWithInvitationMagicLink(w http.ResponseWriter, r *http.Request) {
	...
	if err := render.JSON(w, http.StatusOK, mapper.AuthenticateWithInvitationMagicLinkOutputToResponse(out)); err != nil {
		render.Error(r.Context(), w, err)
		return
	}
}
...
func (h *AuthHandler) RegisterWithInvitationMagicLink(w http.ResponseWriter, r *http.Request) {
	...
	if err := render.JSON(w, http.StatusOK, mapper.RegisterWithInvitationMagicLinkOutputToResponse(out)); err != nil {
		render.Error(r.Context(), w, err)
		return
	}
}
...
func (h *AuthHandler) RequestGoogleAuthLink(w http.ResponseWriter, r *http.Request) {
	...
	if err := render.JSON(w, http.StatusOK, mapper.RequestGoogleAuthLinkOutputToResponse(out)); err != nil {
		render.Error(r.Context(), w, err)
		return
	}
}
...
func (h *AuthHandler) AuthenticateWithGoogle(w http.ResponseWriter, r *http.Request) {
	...
	if err := render.JSON(w, http.StatusOK, mapper.AuthenticateWithGoogleOutputToResponse(out)); err != nil {
		render.Error(r.Context(), w, err)
		return
	}
}
...
func (h *AuthHandler) RegisterWithGoogle(w http.ResponseWriter, r *http.Request) {
	...
	if err := render.JSON(w, http.StatusOK, mapper.RegisterWithGoogleOutputToResponse(out)); err != nil {
		render.Error(r.Context(), w, err)
		return
	}
}
...
func (h *AuthHandler) RequestInvitationGoogleAuthLink(w http.ResponseWriter, r *http.Request) {
	...
	if err := render.JSON(w, http.StatusOK, mapper.RequestInvitationGoogleAuthLinkOutputToResponse(out)); err != nil {
		render.Error(r.Context(), w, err)
		return
	}
}
...
func (h *AuthHandler) RefreshToken(w http.ResponseWriter, r *http.Request) {
	...
	if xsrfTokenHeader == "" {
		render.Error(r.Context(), w, errdefs.ErrUnauthenticated(errors.New("failed to get XSRF token")))
		return
	}

	xsrfTokenCookie, err := r.Cookie("xsrf_token_same_site")
	if err != nil {
		render.Error(r.Context(), w, errdefs.ErrUnauthenticated(err))
		return
	}
	...
	if err := render.JSON(w, http.StatusOK, mapper.RefreshTokenOutputToResponse(out)); err != nil {
		render.Error(r.Context(), w, err)
		return
	}
}
...
func (h *AuthHandler) Save(w http.ResponseWriter, r *http.Request) {
	...
	if err := render.JSON(w, http.StatusOK, mapper.SaveAuthOutputToResponse(out)); err != nil {
		render.Error(r.Context(), w, err)
		return
	}
}
...
func (h *AuthHandler) ObtainAuthToken(w http.ResponseWriter, r *http.Request) {
	...
	if err := render.JSON(w, http.StatusOK, mapper.ObtainAuthTokenOutputToResponse(out)); err != nil {
		render.Error(r.Context(), w, err)
		return
	}
}
...
func (h *AuthHandler) Logout(w http.ResponseWriter, r *http.Request) {
	...
	if err := render.JSON(w, http.StatusOK, &responses.StatusResponse{
		Code:    http.StatusOK,
