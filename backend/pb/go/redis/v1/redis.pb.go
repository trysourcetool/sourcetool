...
const file_redis_v1_redis_proto_rawDesc = "" +
	...
	"\apayload\x18\x02 \x01(\fR\apayloadB\x9f\x01\n" +
	"\fcom.redis.v1B\n" +
	"RedisProtoP\x01ZBgithub.com/trysourcetool/sourcetool/backend/pb/go/redis/v1;redisv1\xa2\x02\x03RXX\xaa\x02\bRedis.V1\xca\x02\bRedis\\V1\xe2\x02\x14Redis\\V1\\GPBMetadata\xea\x02\tRedis::V1b\x06proto3"
