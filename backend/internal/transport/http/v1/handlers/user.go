...
func (h *UserHandler) GetMe(w http.ResponseWriter, r *http.Request) {
	...
	if err := httputil.WriteJSON(w, http.StatusOK, mapper.GetMeOutputToResponse(out)); err != nil {
		httputil.WriteErrJSON(r.Context(), w, err)
		return
	}
}
...
func (h *UserHandler) UpdateMe(w http.ResponseWriter, r *http.Request) {
	...
	if err := httputil.WriteJSON(w, http.StatusOK, mapper.UpdateMeOutputToResponse(out)); err != nil {
		httputil.WriteErrJSON(r.Context(), w, err)
		return
	}
}
...
func (h *UserHandler) UpdateMeEmail(w http.ResponseWriter, r *http.Request) {
	...
	if err := httputil.WriteJSON(w, http.StatusOK, mapper.UpdateMeEmailOutputToResponse(out)); err != nil {
		httputil.WriteErrJSON(r.Context(), w, err)
		return
	}
}
...
func (h *UserHandler) List(w http.ResponseWriter, r *http.Request) {
	...
	if err := httputil.WriteJSON(w, http.StatusOK, mapper.ListUsersOutputToResponse(out)); err != nil {
		httputil.WriteErrJSON(r.Context(), w, err)
		return
	}
}
...
func (h *UserHandler) Update(w http.ResponseWriter, r *http.Request) {
	...
	if err := httputil.WriteJSON(w, http.StatusOK, mapper.UpdateUserOutputToResponse(out)); err != nil {
		httputil.WriteErrJSON(r.Context(), w, err)
		return
	}
}
...
func (h *UserHandler) ResendUserInvitation(w http.ResponseWriter, r *http.Request) {
	...
	if err := httputil.WriteJSON(w, http.StatusOK, mapper.ResendUserInvitationOutputToResponse(out)); err != nil {
		httputil.WriteErrJSON(r.Context(), w, err)
		return
	}
}
...
func (h *UserHandler) CreateUserInvitations(w http.ResponseWriter, r *http.Request) {
	...
	if err := httputil.WriteJSON(w, http.StatusOK, mapper.CreateUserInvitationsOutputToResponse(out)); err != nil {
		httputil.WriteErrJSON(r.Context(), w, err)
		return
	}
}
