...
const file_widget_v1_widget_proto_rawDesc = "" +
	...
	"\x04typeB\xa7\x01\n" +
	"\rcom.widget.v1B\vWidgetProtoP\x01ZDgithub.com/trysourcetool/sourcetool/backend/pb/go/widget/v1;widgetv1\xa2\x02\x03WXX\xaa\x02\tWidget.V1\xca\x02\tWidget\\V1\xe2\x02\x15Widget\\V1\\GPBMetadata\xea\x02\n" +
