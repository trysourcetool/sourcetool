...
const file_exception_v1_exception_proto_rawDesc = "" +
	"\n" +
	"\x1cexception/v1/exception.proto\x12\x17sourcetool.exception.v1\"{\n" +
	"\tException\x12\x14\n" +
	...
	"stackTrace\x12\x1d\n" +
	"\n" +
	"session_id\x18\x04 \x01(\tR\tsessionIdB\x83\x02\n" +
	"\x1bcom.sourcetool.exception.v1B\x0eExceptionProtoP\x01ZTgithub.com/trysourcetool/sourcetool/backend/generated/proto/exception/v1;exceptionv1\xa2\x02\x03SEX\xaa\x02\x17Sourcetool.Exception.V1\xca\x02\x18Sourcetool\\Exception_\\V1\xe2\x02$Sourcetool\\Exception_\\V1\\GPBMetadata\xea\x02\x19Sourcetool::Exception::V1b\x06proto3"
