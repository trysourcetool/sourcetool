...
func (h *APIKeyHandler) Get(w http.ResponseWriter, r *http.Request) {
	...
	if err := httputil.WriteJSON(w, http.StatusOK, mapper.GetAPIKeyOutputToResponse(out)); err != nil {
		httputil.WriteErrJSON(r.Context(), w, err)
		return
	}
}
...
func (h *APIKeyHandler) List(w http.ResponseWriter, r *http.Request) {
	...
	if err := httputil.WriteJSON(w, http.StatusOK, mapper.ListAPIKeysOutputToResponse(out)); err != nil {
		httputil.WriteErrJSON(r.Context(), w, err)
		return
	}
}
...
func (h *APIKeyHandler) Create(w http.ResponseWriter, r *http.Request) {
	...
	if err := httputil.WriteJSON(w, http.StatusOK, mapper.CreateAPIKeyOutputToResponse(out)); err != nil {
		httputil.WriteErrJSON(r.Context(), w, err)
		return
	}
}
...
func (h *APIKeyHandler) Update(w http.ResponseWriter, r *http.Request) {
	...
	if err := httputil.WriteJSON(w, http.StatusOK, mapper.UpdateAPIKeyOutputToResponse(out)); err != nil {
		httputil.WriteErrJSON(r.Context(), w, err)
		return
	}
}
...
func (h *APIKeyHandler) Delete(w http.ResponseWriter, r *http.Request) {
	...
	if err := httputil.WriteJSON(w, http.StatusOK, mapper.DeleteAPIKeyOutputToResponse(out)); err != nil {
		httputil.WriteErrJSON(r.Context(), w, err)
		return
	}
}
