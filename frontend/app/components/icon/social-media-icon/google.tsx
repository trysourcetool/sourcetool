...
export function GoogleIcon(props: { className?: string }) {
  return (
    ...
    >
      <g clipPath="url(#clip0_43_476)">
        <path
          d="M11.9998 9.81815V14.4654H18.458C18.1744 15.96 17.3234 17.2255 16.047 18.0764L19.9416 21.0982C22.2107 19.0037 23.5198 15.9273 23.5198 12.2728C23.5198 11.4219 23.4434 10.6037 23.3015 9.81828L11.9998 9.81815Z"
          fill="#4285F4"
        />
        <path
          d="M5.27468 14.284L4.39631 14.9564L1.28717 17.3782C3.26171 21.2945 7.30868 24 11.9996 24C15.2395 24 17.9558 22.9309 19.9413 21.0982L16.0468 18.0764C14.9777 18.7964 13.614 19.2328 11.9996 19.2328C8.87957 19.2328 6.22874 17.1273 5.27958 14.291L5.27468 14.284Z"
          fill="#34A853"
        />
        <path
