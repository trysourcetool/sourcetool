...
const file_widget_v1_widget_proto_rawDesc = "" +
	"\n" +
	"\x16widget/v1/widget.proto\x12\x14sourcetool.widget.v1\"P\n" +
	"\x06Button\x12\x14\n" +
	...
	"\x06_valueB\x10\n" +
	"\x0e_default_value\"\x9a\x02\n" +
	"\x05Table\x12\x12\n" +
	"\x04data\x18\x01 \x01(\fR\x04data\x126\n" +
	"\x05value\x18\x02 \x01(\v2 .sourcetool.widget.v1.TableValueR\x05value\x12\x16\n" +
	...
	"\n" +
	"TableValue\x12L\n" +
	"\tselection\x18\x01 \x01(\v2).sourcetool.widget.v1.TableValueSelectionH\x00R\tselection\x88\x01\x01B\f\n" +
	"\n" +
	"_selection\";\n" +
	...
	"\bdisabled\x18\x06 \x01(\bR\bdisabledB\b\n" +
	"\x06_valueB\x10\n" +
	"\x0e_default_value\"\xe3\b\n" +
	"\x06Widget\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x126\n" +
	"\x06button\x18\x02 \x01(\v2\x1c.sourcetool.widget.v1.ButtonH\x00R\x06button\x12<\n" +
	"\bcheckbox\x18\x03 \x01(\v2\x1e.sourcetool.widget.v1.CheckboxH\x00R\bcheckbox\x12L\n" +
	"\x0echeckbox_group\x18\x04 \x01(\v2#.sourcetool.widget.v1.CheckboxGroupH\x00R\rcheckboxGroup\x12C\n" +
	"\vcolumn_item\x18\x05 \x01(\v2 .sourcetool.widget.v1.ColumnItemH\x00R\n" +
	"columnItem\x129\n" +
	"\acolumns\x18\x06 \x01(\v2\x1d.sourcetool.widget.v1.ColumnsH\x00R\acolumns\x12@\n" +
	"\n" +
	"date_input\x18\a \x01(\v2\x1f.sourcetool.widget.v1.DateInputH\x00R\tdateInput\x12M\n" +
	"\x0fdate_time_input\x18\b \x01(\v2#.sourcetool.widget.v1.DateTimeInputH\x00R\rdateTimeInput\x120\n" +
	"\x04form\x18\t \x01(\v2\x1a.sourcetool.widget.v1.FormH\x00R\x04form\x12<\n" +
	"\bmarkdown\x18\n" +
	" \x01(\v2\x1e.sourcetool.widget.v1.MarkdownH\x00R\bmarkdown\x12F\n" +
	"\fmulti_select\x18\v \x01(\v2!.sourcetool.widget.v1.MultiSelectH\x00R\vmultiSelect\x12F\n" +
	"\fnumber_input\x18\f \x01(\v2!.sourcetool.widget.v1.NumberInputH\x00R\vnumberInput\x123\n" +
	"\x05radio\x18\r \x01(\v2\x1b.sourcetool.widget.v1.RadioH\x00R\x05radio\x12?\n" +
	"\tselectbox\x18\x0e \x01(\v2\x1f.sourcetool.widget.v1.SelectboxH\x00R\tselectbox\x123\n" +
	"\x05table\x18\x0f \x01(\v2\x1b.sourcetool.widget.v1.TableH\x00R\x05table\x12=\n" +
	"\ttext_area\x18\x10 \x01(\v2\x1e.sourcetool.widget.v1.TextAreaH\x00R\btextArea\x12@\n" +
	"\n" +
	"text_input\x18\x11 \x01(\v2\x1f.sourcetool.widget.v1.TextInputH\x00R\ttextInput\x12@\n" +
	"\n" +
	"time_input\x18\x12 \x01(\v2\x1f.sourcetool.widget.v1.TimeInputH\x00R\ttimeInputB\x06\n" +
	"\x04typeB\xe9\x01\n" +
	"\x18com.sourcetool.widget.v1B\vWidgetProtoP\x01ZNgithub.com/trysourcetool/sourcetool/backend/generated/proto/widget/v1;widgetv1\xa2\x02\x03SWX\xaa\x02\x14Sourcetool.Widget.V1\xca\x02\x14Sourcetool\\Widget\\V1\xe2\x02 Sourcetool\\Widget\\V1\\GPBMetadata\xea\x02\x16Sourcetool::Widget::V1b\x06proto3"
